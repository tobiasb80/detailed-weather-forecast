...
module.exports = import("./detailed-weather-forecast-editor.3862545f.js").then(()=>parcelRequire('JMs79'));
    ...
    _normalizeHeaderChips(config) {
        ...
        if (Array.isArray(config.header_chips)) for (const chip of config.header_chips){
            ...
            if (chip.type === 'attribute') {
                ...
                const name = typeof chip.name === 'string' && chip.name.trim().length > 0 ? chip.name.trim() : attr;
                normalized.push({
                    type: 'attribute',
                    attribute: attr,
            ...
            if (chip.type === 'entity') {
                ...
                const tap_action = typeof chip.tap_action === 'object' && chip.tap_action ? chip.tap_action : undefined;
                const icon = typeof chip.icon === 'string' ? chip.icon.trim() : undefined;
                const name = typeof chip.name === 'string' && chip.name.trim().length > 0 ? chip.name.trim() : entity;
                normalized.push({
                    type: 'entity',
                    entity: entity,
                    tap_action: tap_action,
    ...
    `;
      ...
      <ha-card style=${cardStyle}>
        ${showHeader ? (0, $l56HR.html)`
              <div class=${(0, $ca7e425cc484d5ff$export$56cc687933817664)(headerClassMap)} style=${(0, $2e9FX.styleMap)(headerStyles)}>
                <div class="header-content">
                  ${(0, $l56HR.html)` ${headerLayoutTemplate} ${showInlineNowcast ? nowcastPanelTemplate : (0, $l56HR.nothing)} `}
                </div>
              </div>
            ` : (0, $l56HR.nothing)}
