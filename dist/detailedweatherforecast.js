 ...
 */ function $0dbad5fc6fe57972$export$1bdbe53f9df1b8(o, n, r) {
    ...
    return "object" == typeof o ? (s = o.slot, l = o) : l = {
        flatten: n
    }, r ? (0, $jdBY0.queryAssignedElements)({
        slot: s,
        flatten: n,
        selector: r
...
$parcel$export(module.exports, "getCurrentWeatherStateIcon", () => $a670ed82a1e76f75$export$f48c3396862889ec);
...
const $a670ed82a1e76f75$export$f48c3396862889ec = (entity, element, nightTime, iconMap)=>{
    ...
    if (pictocode) {
        let pictoCodeIcon;
        if (nightTime) pictoCodeIcon = 'local:' + pictocode.toString().padStart(2, '0') + '_night';
        else pictoCodeIcon = 'local:' + pictocode.toString().padStart(2, '0') + '_day';
        return (0, $l56HR.html)`<ha-icon icon=${pictoCodeIcon}></ha-icon>`;
    }
    if (normalizedIcon) return (0, $l56HR.html)`<ha-icon icon=${normalizedIcon}></ha-icon>`;
...
const $a670ed82a1e76f75$var$supportsFeature = (stateObj, feature)=>$a670ed82a1e76f75$var$supportsFeatureFromAttributes(stateObj.attributes, feature);
// Copied from frontend/src/common/entity/supports-feature.ts
const $a670ed82a1e76f75$var$supportsFeatureFromAttributes = (attributes, feature)=>// eslint-disable-next-line no-bitwise
...
const $a670ed82a1e76f75$export$b2983052dc371198 = (hass, weather, attribute, name, unit, icon, divisor)=>{
    ...
    if (typeof rawValue === 'number') {
        if (attribute === 'wind_speed') {
            ...
            display = $a670ed82a1e76f75$var$getWind(hass, weather, rawValue, typeof bearingValue === 'number' ? bearingValue : undefined);
        ...
        } else display = hass?.formatEntityAttributeValue?.(weather, attribute, rawValue) || rawValue.toLocaleString(hass?.locale?.language, {
    ...
    name = name || hass.formatEntityAttributeName(weather, attribute) || hass.localize($a670ed82a1e76f75$var$getLocalizationKey(attribute)) || attribute.replace(/_/g, ' ');
    return {
        value: value,
        name: name,
        icon: resolvedIcon
...
const $a670ed82a1e76f75$export$34eb39cb0547b64f = (hass, weather, attribute)=>{
    return hass.formatEntityAttributeName(weather, attribute) || hass.localize($a670ed82a1e76f75$var$getLocalizationKey(attribute)) || attribute.replace(/_/g, ' ');
};
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */ const $19f464fcda7d2482$var$i = "important", $19f464fcda7d2482$var$n = " !" + $19f464fcda7d2482$var$i, $19f464fcda7d2482$export$1e5b4ce2fa884e6a = (0, $1pJSR.directive)(class extends (0, $1pJSR.Directive) {
    constructor(t){
        var e;
        if (super(t), t.type !== (0, $1pJSR.PartType).ATTRIBUTE || "style" !== t.name || (null === (e = t.strings) || void 0 === e ? void 0 : e.length) > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
    }
    render(t) {
...
function $405177f8a3c8228b$export$b3bd0bc58e36cd63(key, search = '', replace = '') {
    ...
    if (translated === undefined) // Try english as a fallback
    translated = $405177f8a3c8228b$var$getTranslated(key, 'en', translations);
    if (translated === undefined) // Fallback to the key itself
    translated = key;
...
var $cbe104d9b0787356$export$2e2bcd8739ae039 = {
    editor: {
        ...
        main: {
            ...
            header_temperature_entity: "Lokaler Temperatursensor (\xdcberschreibt den aktuellen Temperaturwert der Vorhersage)",
            ...
            nowcast_entity: "Nowcast-Entit\xe4t (F\xfcr den Niederschlag der n\xe4chsten Stunde. Die Entit\xe4tsintegration muss eine `get_minute_forecast`-Aktion bereitstellen, um die Daten abzurufen.)",
        ...
        section: {
            ...
            gps_coordinates_description: "Wird f\xfcr Sonnenaufgangs-/Sonnenuntergangsmarkierungen und Tag-/Nachthintergr\xfcnde ben\xf6tigt",
            ...
            solar_forecast_description: 'Die Vorhersage muss einer Solarmodul-Konfiguration in den Energie-Dashboard-Einstellungen zugewiesen werden. Andernfalls kann sie hier nicht verwendet werden.',
            ...
            custom_icons_description: "\xdcberschreiben Sie die Standard-Wettersymbole mit einem beliebigen in Home Assistant verf\xfcgbaren Symbol.",
            header: 'Kopfzeile',
            chips: 'Chips',
            ...
            header_info_description: "Attribute und Entit\xe4ten konfigurieren, die bei Klick auf die Wetterbedingung unterhalb der Kopfzeile angezeigt werden sollen.",
            ...
            daily_forecast_info_description: "Attribute konfigurieren, die unterhalb der t\xe4glichen Vorhersage angezeigt werden sollen, wenn ein Tag ausgew\xe4hlt wurde.",
            ...
            hourly_forecast_info_description: "Attribute konfigurieren, die unterhalb der st\xfcndlichen Vorhersage angezeigt werden sollen, wenn eine Stunde ausgew\xe4hlt wurde."
        },
        common: {
            none: 'Keine',
            solar_forecast: 'Solarenergie-Vorhersage'
...
var $2b88f79e58384381$export$2e2bcd8739ae039 = {
    editor: {
        ...
        main: {
            ...
            header_temperature_entity: 'Local Temperature Sensor Entity (Overrides the current temperature value of the forecast)',
            ...
            nowcast_entity: 'Nowcast Entity (For next-hour precipitation. The entity integration must provide a get_minute_forecast action to fetch the data.)',
            nowcast_layout: 'Nowcast layout',
        ...
        section: {
            ...
            solar_forecast_description: "The forecast needs to be assigned to a solar panel configuration in the Energy dashboard settings. Otherwise it can't be used here.",
            ...
            header_info_description: 'Configure attributes and entities to be displayed below the header when the weather condition is clicked.',
            ...
            daily_forecast_info_description: 'Configure attributes to be displayed below the daily forecast when a day is selected.',
            ...
            hourly_forecast_info_description: 'Configure attributes to be displayed below the hourly forecast when an hour is selected.'
        },
        common: {
            none: 'None',
            solar_forecast: 'Solar forecast'
...
module.exports = import("./detailed-weather-forecast-editor.48fb3b04.js").then(()=>parcelRequire('JMs79'));
 ...
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */ const $ca7e425cc484d5ff$export$56cc687933817664 = (0, $1pJSR.directive)(class extends (0, $1pJSR.Directive) {
    constructor(t){
        var i;
        if (super(t), t.type !== (0, $1pJSR.PartType).ATTRIBUTE || "class" !== t.name || (null === (i = t.strings) || void 0 === i ? void 0 : i.length) > 2) throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.");
    }
    render(t) {
...
class $8ed6a55a910eb2d2$export$afaa23c7706bed5a extends (0, $eGUNk.LitElement) {
    ...
    render() {
        ...
        const attributeTemplates = this.attributeConfigs.map((attrConfig)=>this._renderAttribute(attrConfig)).filter((template)=>template !== (0, $l56HR.nothing));
    ...
    _renderAttribute(attrConfig) {
        ...
        if (attrConfig.type == 'entity') {
            ...
            const formatted = (0, $7Yo7j.formatWeatherAttribute)(this.hass, this.weatherEntity, attrConfig.attribute, attrConfig.name, attrConfig.unit, attrConfig.icon, attrConfig.divisor);
        ...
        const hasTapAction = (0, $ee1328194d522913$export$e217e69099d082f5)(attrConfig.tap_action);
        ...
        return (0, $l56HR.html)`
      <div
        class=${(0, $ca7e425cc484d5ff$export$56cc687933817664)(attributeClassMap)}
        role=${hasTapAction ? 'button' : (0, $l56HR.nothing)}
        tabindex=${hasTapAction ? 0 : (0, $l56HR.nothing)}
        @click=${()=>this._handleAttributeTap(attrConfig)}
        @keydown=${(ev)=>this._handleAttributeKeydown(ev, attrConfig)}
      >
        <ha-attribute-icon
    ...
    _executeTapAction(actionConfig, entityOverride) {
        if (!this.hass || !actionConfig || !(0, $ee1328194d522913$export$e217e69099d082f5)(actionConfig)) return;
        ...
        (0, $ee1328194d522913$export$6c6c3f4b7541eaf1)(this, this.hass, {
            entity: entityOverride || this.weatherEntity.entity_id,
            tap_action: actionConfig
        }, 'tap');
    }
    _handleAttributeTap(attrConfig) {
        if (!(0, $ee1328194d522913$export$e217e69099d082f5)(attrConfig.tap_action)) return;
        const entity = attrConfig.type === 'entity' ? attrConfig.entity : undefined;
        this._executeTapAction(attrConfig.tap_action, entity);
    }
    _handleAttributeKeydown(ev, attrConfig) {
...
], $8ed6a55a910eb2d2$export$afaa23c7706bed5a.prototype, "hass", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $8ed6a55a910eb2d2$export$afaa23c7706bed5a.prototype, "weatherEntity", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $8ed6a55a910eb2d2$export$afaa23c7706bed5a.prototype, "attributeConfigs", void 0);
...
const $2e3b0c24d7649e32$var$formatDateWeekdayShortMem = (0, $gztya.default)((locale, serverTimeZone)=>new Intl.DateTimeFormat(locale.language, {
        weekday: 'short',
...
const $2e3b0c24d7649e32$var$formatTimeMem = (0, $gztya.default)((locale, serverTimeZone)=>new Intl.DateTimeFormat(locale.language, {
        hour: 'numeric',
        minute: 'numeric',
...
const $2e3b0c24d7649e32$var$formatDateDayTwoDigitMem = (0, $gztya.default)((locale, serverTimeZone)=>new Intl.DateTimeFormat(locale.language, {
        day: '2-digit',
        timeZone: locale.time_zone === 'server' ? serverTimeZone : undefined
    }));
...
const $2e3b0c24d7649e32$var$formatHourMem = (0, $gztya.default)((locale, serverTimeZone)=>new Intl.DateTimeFormat(locale.language, {
        hour: '2-digit',
        //minute: "2-digit",
        hourCycle: $2e3b0c24d7649e32$export$98b044737b007ca6(locale) ? 'h12' : 'h23',
        timeZone: locale.time_zone === 'server' ? serverTimeZone : undefined
...
class $66ea163cabb49f55$export$7edf3521b67cbe51 extends (0, $eGUNk.LitElement) {
    ...
    render() {
        ...
        const precipitationScale = this._computePrecipitationScale($66ea163cabb49f55$var$DAILY_PRECIPITATION_MIN_SCALE, $66ea163cabb49f55$var$DAILY_PRECIPITATION_MAX_SCALE);
    ...
    _renderDailyItem(item, precipitationScale) {
      ...
      <div class="forecast-item" @click=${()=>this._handleSelect(item)}>
        ...
        <div class="templow" style=${tempLowColor ? (0, $2e9FX.styleMap)({
            color: tempLowColor
        }) : (0, $l56HR.nothing)}>
    ...
    _handleSelect(item) {
        ...
        if (detailShow?.datetime !== this._showForecastAttribute?.datetime) {
            ...
            this.dispatchEvent(new CustomEvent('dwf-daily-list-item-show-attributes', {
                detail: detailShow,
                bubbles: true,
                composed: true
            }));
        ...
        if (item.datetime !== this._selectedForecast?.datetime) {
            ...
            this.dispatchEvent(new CustomEvent('dwf-daily-list-item-selected', {
                detail: item,
                bubbles: true,
                composed: true
            }));
    ...
    _renderPrecipitationInfo(item, precipitationScale) {
        ...
        if ((precipitationValue ?? 0) > $66ea163cabb49f55$var$PRECIPITATION_DISPLAY_THRESHOLD) precipitationClasses.push('active');
        let overflow = false;
        let precipitationStyle = (0, $l56HR.nothing);
        if (precipitationScale !== undefined && precipitationValue !== undefined && precipitationValue >= $66ea163cabb49f55$var$PRECIPITATION_DISPLAY_THRESHOLD) {
      ...
      ${hasPrecipitationProbability ? (0, $l56HR.html)`<div
    ...
    _renderExtraAttribute(item) {
        ...
        const formatted = (0, $7Yo7j.formatForecastAttribute)(this.hass, this.weatherEntity, item, key, undefined, this.extraAttributeUnit, undefined, this.extraAttributeDivisor);
        if (!formatted) return 0, $l56HR.nothing;
        ...
        const style = color ? (0, $2e9FX.styleMap)({
            color: color,
...
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "hass", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "weatherEntity", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "forecast", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "precipitationUnit", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "extraAttribute", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "extraAttributeUnit", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "extraAttributeDivisor", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "extraAttributeColor", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "extraAttributeDimBelow", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "iconMap", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "_selectedForecast", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $66ea163cabb49f55$export$7edf3521b67cbe51.prototype, "_showForecastAttribute", void 0);
...
class $a253ecda494e9dab$export$b2d0e3ce4f7eb09a extends (0, $eGUNk.LitElement) {
    ...
    render() {
        ...
        const dateFormatted = this.dailyForecast ? `${(0, $2e3b0c24d7649e32$export$e86782e02be44113)(date, this.hass.locale, this.hass.config)}` : `${(0, $2e3b0c24d7649e32$export$e86782e02be44113)(date, this.hass.locale, this.hass.config)}, ${(0, $2e3b0c24d7649e32$export$3203edd9e5edd663)(date, this.hass.locale, this.hass.config)}`;
        ...
        } else headerCondition = this.hass.formatEntityState?.({
            ...this.weatherEntity,
      ...
      ${attributeTemplates.length > 0 ? (0, $l56HR.html)`<div class="dwf-current-attributes">${attributeTemplates}</div>` : (0, $l56HR.nothing)}
    `;
    }
    _renderAttribute(attrConfig) {
        const stateObj = this.weatherEntity;
        const forecast = this.forecastAttribute;
        const formatted = (0, $7Yo7j.formatForecastAttribute)(this.hass, stateObj, forecast, attrConfig.attribute, attrConfig.name, attrConfig.unit, attrConfig.icon, attrConfig.divisor);
        if (!formatted) return 0, $l56HR.nothing;
...
], $a253ecda494e9dab$export$b2d0e3ce4f7eb09a.prototype, "hass", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $a253ecda494e9dab$export$b2d0e3ce4f7eb09a.prototype, "weatherEntity", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $a253ecda494e9dab$export$b2d0e3ce4f7eb09a.prototype, "forecastAttribute", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $a253ecda494e9dab$export$b2d0e3ce4f7eb09a.prototype, "attributeConfigs", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $a253ecda494e9dab$export$b2d0e3ce4f7eb09a.prototype, "dailyForecast", void 0);
...
class $ea025a0870b01c22$export$c9c54dc28d564056 extends (0, $eGUNk.LitElement) {
    ...
    render() {
        ...
        const parts = [];
        let currentDay;
        const precipitationScale = this._computePrecipitationScale($ea025a0870b01c22$var$HOURLY_PRECIPITATION_MIN_SCALE, $ea025a0870b01c22$var$HOURLY_PRECIPITATION_MAX_SCALE);
        ...
        if (firstVisibleItem) {
            ...
            if (datetime) {
                ...
                if (this._currentDayKey !== dayKey) {
                    ...
                    this.dispatchEvent(new CustomEvent('dwf-hourly-scrolled-to-new-day', {
                        detail: {
                            date: date
                        },
                        bubbles: true,
    ...
    _handleItemClick(item) {
        ...
        this.dispatchEvent(new CustomEvent('dwf-hourly-list-item-selected', {
            detail: detail,
            bubbles: true,
            composed: true
        }));
    ...
    _renderPrecipitationInfo(item, precipitationScale) {
        ...
        if ((precipitationValue ?? 0) > $ea025a0870b01c22$var$PRECIPITATION_DISPLAY_THRESHOLD) precipitationClasses.push('active');
        let overflow = false;
        let precipitationStyle = (0, $l56HR.nothing);
        if (precipitationScale !== undefined && precipitationValue !== undefined && precipitationValue >= $ea025a0870b01c22$var$PRECIPITATION_DISPLAY_THRESHOLD) {
            const normalized = precipitationScale > 0 ? Math.min(precipitationValue / precipitationScale, 1) : 0;
            const percent = `${(normalized * 100).toFixed(2)}%`;
            precipitationStyle = `--precipitation-fill: ${percent};`;
            overflow = precipitationValue > precipitationScale;
    ...
    constructor(...args){
        super(...args), this.forecast = [], this.showSunTimes = false, this._sunTimesByDay = {}, this._boundHandleScroll = this._handleScroll.bind(this);
    }
}
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
...
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "hass", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "weatherEntity", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "forecast", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "showSunTimes", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "sunCoordinates", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "precipitationUnit", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "extraAttribute", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "extraAttributeUnit", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "extraAttributeDivisor", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "extraAttributeColor", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "extraAttributeDimBelow", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "iconMap", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $ea025a0870b01c22$export$c9c54dc28d564056.prototype, "selectedItem", void 0);
...
class $55e003afb1fbd220$export$b48955384eb43fb8 extends (0, $eGUNk.LitElement) {
    ...
    _computeLabelOffset(width) {
        ...
        const timestamps = this.forecast.map((item)=>new Date(item.datetime).getTime()).filter((timestamp)=>Number.isFinite(timestamp)).sort((a, b)=>a - b);
    ...
    _buildMinuteSeries() {
        const normalized = (Array.isArray(this.forecast) ? this.forecast : []).map((item)=>{
    ...
    constructor(...args){
        super(...args), this.forecast = [], this._barStride = 1, this._barGap = $55e003afb1fbd220$var$NOWCAST_BASE_GAP_PX, this._containerWidth = 0;
    }
}
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
...
], $55e003afb1fbd220$export$b48955384eb43fb8.prototype, "forecast", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $55e003afb1fbd220$export$b48955384eb43fb8.prototype, "_barStride", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $55e003afb1fbd220$export$b48955384eb43fb8.prototype, "_barGap", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $55e003afb1fbd220$export$b48955384eb43fb8.prototype, "_containerWidth", void 0);
...
], $29c7a4796ec4f67a$export$34bfddd8b6e6d6f8.prototype, "headerClassMap", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $29c7a4796ec4f67a$export$34bfddd8b6e6d6f8.prototype, "headerStyles", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $29c7a4796ec4f67a$export$34bfddd8b6e6d6f8.prototype, "headerLayoutTemplate", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        type: Boolean
    })
], $29c7a4796ec4f67a$export$34bfddd8b6e6d6f8.prototype, "showInlineNowcast", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $29c7a4796ec4f67a$export$34bfddd8b6e6d6f8.prototype, "nowcastPanelTemplate", void 0);
customElements.define('dwf-header', $29c7a4796ec4f67a$export$34bfddd8b6e6d6f8);
...
var $7Yo7j = parcelRequire("7Yo7j");
var $d7003433b68fc15c$exports = {};
$d7003433b68fc15c$exports = "ha-card {\n  flex-direction: column;\n  height: 100%;\n  display: flex;\n  overflow: hidden;\n}\n\n.weather {\n  width: 100%;\n  min-height: var(--dwf-header-height, calc(2.3 * var(--row-height, 56px)));\n  border-top-left-radius: var(--ha-card-border-radius, 12px);\n  border-top-right-radius: var(--ha-card-border-radius, 12px);\n  color: #fff;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  flex-direction: column;\n  flex-shrink: 0;\n  display: flex;\n}\n\n.weather.header-only {\n  border-bottom-left-radius: var(--ha-card-border-radius, 12px);\n  border-bottom-right-radius: var(--ha-card-border-radius, 12px);\n  flex: auto;\n  height: 100%;\n}\n\n.weather .header-content {\n  padding-block: var(--dwf-header-padding-block, 16px);\n  padding-inline: var(--dwf-header-padding-inline, 16px);\n  gap: var(--dwf-header-content-gap, 12px);\n  box-sizing: border-box;\n  flex-direction: column;\n  flex: auto;\n  width: 100%;\n  min-width: 0;\n  display: flex;\n}\n\n.weather .header-layout {\n  flex-direction: row;\n  flex: none;\n  justify-content: flex-start;\n  align-items: stretch;\n  gap: 0;\n  width: 100%;\n  min-width: 0;\n  display: flex;\n}\n\n.weather .header-main {\n  padding-left: var(--dwf-header-columns-gap, 16px);\n  justify-content: space-between;\n  align-items: flex-end;\n  gap: var(--dwf-header-main-gap, 10px);\n  flex-direction: column;\n  flex: 0 auto;\n  align-self: stretch;\n  min-width: 0;\n  min-height: 0;\n  margin-left: auto;\n  display: flex;\n}\n\n.weather .header-attributes {\n  justify-content: space-between;\n  gap: var(--dwf-header-attribute-gap, 8px);\n  flex-direction: column;\n  flex: 1 1 0;\n  align-self: stretch;\n  min-width: 30%;\n  min-height: 0;\n  display: flex;\n}\n\n.weather .attribute-chip {\n  font-size: var(--ha-font-size-m);\n  line-height: calc(6px + var(--ha-font-size-m));\n  padding: var(--ha-space-1, 4px) var(--ha-space-3, 12px);\n  color: inherit;\n  background-color: #00000059;\n  border-radius: 25px;\n  align-self: flex-start;\n  align-items: center;\n  min-width: 0;\n  max-width: 100%;\n  display: inline-flex;\n  overflow: hidden;\n}\n\n.weather .attribute-chip .chip-icon {\n  --mdc-icon-size: 20px;\n  color: inherit;\n  margin-right: 6px;\n}\n\n.weather .attribute-chip.has-action {\n  cursor: pointer;\n}\n\n.weather .attribute-chip.has-action:focus-visible {\n  outline-offset: 2px;\n  outline: 2px solid #ffffffe6;\n}\n\n.weather .attribute-chip.missing {\n  opacity: .8;\n  font-style: italic;\n}\n\n.weather .condition {\n  font-size: var(--ha-font-size-xl);\n  line-height: calc(10px + var(--ha-font-size-xl));\n  padding: var(--ha-space-1, 4px) var(--ha-space-4, 16px);\n  background-color: #0000004d;\n  border-radius: 25px;\n  justify-content: center;\n  align-items: center;\n  min-width: 0;\n  max-width: 70%;\n  display: inline-flex;\n  overflow: hidden;\n}\n\n.weather .temp.has-action, .weather .condition.has-action {\n  cursor: pointer;\n}\n\n.weather .temp.has-action:focus-visible, .weather .condition.has-action:focus-visible {\n  outline-offset: 2px;\n  outline: 2px solid #ffffffe6;\n}\n\n.weather .temp {\n  font-size: var(--ha-font-size-5xl);\n  line-height: calc(10px + var(--ha-font-size-xl));\n  font-weight: var(--ha-font-weight-bold, bold);\n  padding: 2px var(--ha-space-4, 16px);\n  background-color: #0000004d;\n  border-radius: 25px;\n  justify-content: center;\n  align-items: center;\n  min-width: 0;\n  max-width: 100%;\n  display: inline-flex;\n  overflow: hidden;\n}\n\n.weather .header-pill-text {\n  white-space: normal;\n  flex: 0 auto;\n  min-width: 0;\n}\n\n.weather .nowcast-panel {\n  padding: var(--ha-space-3, 12px) var(--ha-space-3, 12px) 6px var(--ha-space-3, 12px);\n  background: #0000004d;\n  border-radius: 16px;\n  flex-direction: column;\n  flex: auto;\n  min-height: 0;\n  display: flex;\n}\n\n.weather dwf-nowcast {\n  flex-direction: column;\n  flex: auto;\n  gap: 0;\n  width: 100%;\n  min-width: 0;\n  height: 100%;\n  min-height: 0;\n  display: flex;\n  overflow: hidden;\n}\n\n.weather .nowcast-bars {\n  align-items: stretch;\n  gap: var(--dwf-nowcast-gap, 5px);\n  flex: auto;\n  min-height: 24px;\n  display: flex;\n}\n\n.weather .nowcast-bar {\n  background: #ffffff06;\n  border-radius: 999px;\n  flex: 1 1 0;\n  align-self: stretch;\n  align-items: flex-end;\n  height: auto;\n  min-height: 6px;\n  display: flex;\n  overflow: hidden;\n}\n\n.weather .nowcast-bar-fill {\n  background: var(--dwf-nowcast-fill-color, #4aafff);\n  border-radius: inherit;\n  width: 100%;\n  height: 0%;\n  transition: height .35s;\n}\n\n@media (prefers-reduced-motion: reduce) {\n  .weather .nowcast-bar-fill, .weather .nowcast-labels {\n    transition: none;\n  }\n}\n\n.weather .nowcast-labels {\n  font-size: var(--ha-font-size-s);\n  color: #fff;\n  will-change: transform;\n  justify-content: space-between;\n  transition: transform .35s;\n  display: flex;\n}\n\n.forecast-container {\n  width: 100%;\n  padding-top: var(--ha-space-1, 4px);\n  padding-bottom: var(--ha-space-5, 20px);\n  flex-direction: column;\n  flex: 0 auto;\n  gap: 4px;\n  display: flex;\n}\n\n.divider {\n  background-color: var(--primary-background-color);\n}\n\n.card-divider {\n  height: 4px;\n}\n\n.forecast-divider {\n  border-radius: 2px;\n}\n\n.forecast-container > .forecast-divider {\n  height: 4px;\n  margin: 14px 16px 4px;\n}\n\n.forecast-daily-container, .forecast-hourly-container {\n  touch-action: pan-x;\n  overscroll-behavior-x: contain;\n  flex-direction: column;\n  flex: 0 auto;\n  justify-content: flex-start;\n  display: flex;\n  position: relative;\n  overflow: hidden;\n}\n\n.fade-left, .fade-right {\n  pointer-events: none;\n  z-index: 2;\n  width: 16px;\n  position: absolute;\n  top: 0;\n  bottom: 0;\n}\n\n.fade-left {\n  background: linear-gradient(to right,\n    var(--card-background-color) 0%,\n    var(--card-background-color) 2px,\n    transparent 100%);\n  left: 0;\n}\n\n.fade-right {\n  background: linear-gradient(to left,\n    var(--card-background-color) 0%,\n    var(--card-background-color) 2px,\n    transparent 100%);\n  right: 0;\n}\n\n.forecast {\n  --forecast-inline-padding: 16px;\n  scroll-snap-type: x mandatory;\n  height: auto;\n  scroll-padding-left: var(--forecast-inline-padding);\n  scroll-padding-right: var(--forecast-inline-padding);\n  justify-content: space-around;\n  align-items: stretch;\n  gap: var(--dynamic-gap, 20px);\n  padding: var(--ha-space-2, 8px) var(--forecast-inline-padding) 0px;\n  flex: 0 auto;\n  display: flex;\n  overflow: auto clip;\n}\n\n@supports (-webkit-touch-callout: none) {\n  .forecast {\n    padding-bottom: var(--ha-space-3, 12px);\n  }\n}\n\n.forecast dwf-daily-list, .forecast dwf-hourly-list {\n  display: contents;\n}\n\n.forecast.daily {\n  --min-gap: 30px;\n  --icon-size: 60px;\n  --icon-container-width: 60px;\n  cursor: grab;\n  -webkit-user-select: none;\n  user-select: none;\n}\n\n.forecast.hourly {\n  --min-gap: 16px;\n  --icon-size: 60px;\n  --icon-container-width: 60px;\n  --day-marker-width: 60px;\n  cursor: grab;\n  -webkit-user-select: none;\n  user-select: none;\n  padding-top: 32px;\n}\n\n.forecast.hourly.dragging, .forecast.hourly.momentum, .forecast.daily.dragging, .forecast.daily.momentum {\n  scroll-snap-type: none;\n}\n\n.forecast.hourly.grabbing, .forecast.daily.grabbing {\n  cursor: grabbing;\n}\n\n.forecast::-webkit-scrollbar {\n  height: 0;\n}\n\n.forecast::-webkit-scrollbar-thumb {\n  background: none;\n}\n\n.forecast::-webkit-scrollbar-track {\n  background: none;\n}\n\n.forecast::-webkit-scrollbar-corner {\n  background: none;\n}\n\n.forecast {\n  -ms-overflow-style: none;\n  scrollbar-width: none;\n}\n\n.forecast::-webkit-scrollbar {\n  display: none;\n}\n\n.forecast-item {\n  scroll-snap-align: start;\n  text-align: center;\n  cursor: pointer;\n  flex-direction: column;\n  height: 100%;\n  display: flex;\n}\n\n.forecast.hourly .forecast-item {\n  width: var(--icon-container-width);\n  align-items: center;\n  overflow: visible;\n}\n\n.forecast.hourly .day-marker {\n  --day-marker-translate-x: calc((var(--dynamic-gap, 20px) + var(--icon-container-width) - var(--day-marker-width)) / 2);\n  left: calc((((var(--day-marker-width) - var(--icon-container-width)) / 2) * -1) - var(--day-marker-translate-x));\n  transform: translateX(var(--day-marker-translate-x)) translateY(-100%);\n  font-weight: var(--ha-font-weight-bold, bold);\n  color: #fff;\n  background-color: var(--state-climate-cool-color);\n  pointer-events: none;\n  white-space: nowrap;\n  z-index: 3;\n  scroll-snap-align: none;\n  width: var(--day-marker-width);\n  margin-right: calc(var(--day-marker-width) * -1 - var(--dynamic-gap) / 2);\n  margin-right: calc(round(up, var(--day-marker-width) * -1 - var(--dynamic-gap) / 2, 1px));\n  margin-left: calc(var(--dynamic-gap) * -1 / 2);\n  border-radius: 999px;\n  flex: none;\n  justify-content: center;\n  align-self: start;\n  align-items: center;\n  display: inline-flex;\n  position: sticky;\n}\n\n.forecast .day-of-month {\n  opacity: .3;\n  margin-top: -4px;\n  font-size: 13px;\n}\n\n.forecast .date.sunrise {\n  color: var(--orange-color, #ff9800);\n  font-weight: var(--ha-font-weight-medium, 500);\n}\n\n.forecast .date.sunset {\n  color: var(--purple-color, #926bc7);\n  font-weight: var(--ha-font-weight-medium, 500);\n}\n\n.forecast.daily .date.selected {\n  background-color: var(--state-climate-cool-color);\n  color: #fff;\n  border-radius: 999px;\n}\n\n.forecast.hourly .date {\n  width: var(--icon-container-width);\n  text-align: center;\n  white-space: nowrap;\n  justify-content: center;\n  align-items: center;\n  margin: 0 auto;\n  display: flex;\n}\n\n.forecast.hourly .date.selected {\n  background-color: var(--state-climate-cool-color);\n  color: #fff;\n  border-radius: 999px;\n}\n\n.forecast .ampm {\n  opacity: .3;\n  font-size: 11px;\n}\n\n.forecast .temp {\n  font-size: var(--ha-font-size-xl);\n  font-weight: var(--ha-font-weight-bold, bold);\n}\n\n.forecast .templow {\n  opacity: .5;\n  font-weight: var(--ha-font-weight-bold, bold);\n  font-size: var(--ha-font-size-l);\n}\n\n.forecast .precipitation, .forecast .precipitationprobability {\n  opacity: .3;\n  color: var(--state-climate-cool-color);\n  min-height: 20px;\n}\n\n.forecast .hourly-extra {\n  opacity: .6;\n  color: var(--primary-text-color);\n  min-height: 20px;\n  font-weight: var(--ha-font-weight-medium, 500);\n  white-space: nowrap;\n}\n\n.forecast .hourly-extra.dimmed {\n  opacity: .3;\n}\n\n.forecast .precipitation {\n  --precipitation-fill: 0%;\n  --dwf-precipitation-indicator-color: var(--state-climate-cool-color);\n  --dwf-precipitation-indicator-opacity: .2;\n  --dwf-precipitation-indicator-padding-inline: 8px;\n  --dwf-precipitation-indicator-padding-block: 0px;\n  --dwf-precipitation-indicator-offset-top: 0px;\n  --dwf-precipitation-indicator-offset-bottom: 0px;\n  padding-inline: var(--dwf-precipitation-indicator-padding-inline);\n  padding-block: var(--dwf-precipitation-indicator-padding-block);\n  border-radius: var(--dwf-precipitation-indicator-radius, 4px);\n  z-index: 0;\n  display: inline-block;\n  position: relative;\n  overflow: hidden;\n}\n\n.forecast .precipitation:before {\n  content: \"\";\n  inset-inline: 0;\n  top: calc(100% - var(--precipitation-fill, 0%) - var(--dwf-precipitation-indicator-offset-top, 0px));\n  bottom: calc(0px - var(--dwf-precipitation-indicator-offset-bottom, 0px));\n  background-color: var(--dwf-precipitation-indicator-color, var(--state-climate-cool-color));\n  opacity: var(--dwf-precipitation-indicator-opacity, .2);\n  border-radius: inherit;\n  pointer-events: none;\n  z-index: -1;\n  transition: top .15s ease-in-out, background-color .15s ease-in-out;\n  position: absolute;\n}\n\n.forecast .precipitation.overflow {\n  --dwf-precipitation-indicator-color: var(--red-color, #f44336);\n  color: var(--red-color, #f44336);\n}\n\n.forecast.daily .forecast-item > .precipitation {\n  line-height: 18px;\n}\n\n.forecast .precipitation.active, .forecast .precipitationprobability.active {\n  opacity: 1;\n}\n\n.forecast .daily-extra {\n  opacity: .6;\n  color: var(--primary-text-color);\n  min-height: 20px;\n  font-weight: var(--ha-font-weight-medium, 500);\n  white-space: nowrap;\n}\n\n.forecast .daily-extra.dimmed {\n  opacity: .3;\n}\n\n.forecast.daily .daily-extra.precipitationprobability {\n  color: var(--state-climate-cool-color);\n  opacity: .3;\n  display: block !important;\n}\n\n.forecast .daily-extra.precipitationprobability.active {\n  opacity: 1;\n}\n\n.forecast.daily .forecast-item {\n  grid-auto-rows: max-content;\n  align-content: start;\n  display: grid;\n}\n\n.forecast.daily .forecast-item > .date, .forecast.daily .forecast-item > .day-of-month, .forecast.daily .forecast-item > .precipitation, .forecast.daily .forecast-item > .precipitationprobability, .forecast.daily .forecast-item > .daily-extra {\n  min-height: auto;\n}\n\n.forecast.daily .forecast-item > .date {\n  grid-row: 1;\n}\n\n.forecast.daily .forecast-item > .day-of-month {\n  grid-row: 2;\n}\n\n.forecast.daily .forecast-item > .forecast-image-icon {\n  grid-row: 3;\n}\n\n.forecast.daily .forecast-item > .temp {\n  grid-row: 4;\n}\n\n.forecast.daily .forecast-item > .templow {\n  grid-row: 5;\n}\n\n.forecast.daily .forecast-item > .precipitation {\n  grid-row: 6;\n}\n\n.forecast.daily .forecast-item > .precipitationprobability {\n  grid-row: 7;\n}\n\n.forecast.daily .forecast-item > .daily-extra {\n  text-align: center;\n  width: var(--icon-size);\n  grid-row: 8;\n  justify-self: center;\n}\n\n.forecast-image-icon {\n  justify-content: center;\n  display: flex;\n}\n\n.forecast-image-icon > * {\n  width: var(--icon-size);\n  height: var(--icon-size);\n}\n\n.forecast-image-icon ha-icon {\n  --mdc-icon-size: var(--icon-size);\n}\n\n.rain {\n  fill: var(--weather-icon-rain-color, #30b3ff);\n}\n\n.sun {\n  fill: var(--weather-icon-sun-color, #fdd93c);\n}\n\n.moon {\n  fill: var(--weather-icon-moon-color, #fcf497);\n}\n\n.cloud-back {\n  fill: var(--weather-icon-cloud-back-color, #d4d4d4);\n}\n\n.cloud-front {\n  fill: var(--weather-icon-cloud-front-color, #f9f9f9);\n}\n\n.snow {\n  fill: var(--weather-icon-snow-color, #f9f9f9);\n  stroke: var(--weather-icon-snow-stroke-color, #d4d4d4);\n  stroke-width: 1px;\n  paint-order: stroke;\n}\n\ndwf-current-weather-attributes {\n  display: contents;\n}\n\n.dwf-current-attributes {\n  gap: var(--ha-space-1, 4px);\n  min-width: 0;\n  padding: var(--ha-space-2, 8px) var(--ha-space-4, 16px);\n  flex-direction: column;\n  display: flex;\n}\n\n.dwf-current-attribute {\n  justify-content: space-between;\n  align-items: center;\n  gap: var(--ha-space-1, 4px);\n  font-size: var(--ha-font-size-m, 14px);\n  line-height: var(--ha-line-height-condensed);\n  color: var(--primary-text-color, #212121);\n  white-space: nowrap;\n  flex-direction: row;\n  display: flex;\n}\n\n.dwf-current-attribute.has-action {\n  cursor: pointer;\n}\n\n.dwf-current-attribute-icon {\n  color: var(--state-icon-color, #616161);\n  padding-left: var(--ha-space-2, 8px);\n}\n\n.dwf-current-attribute-value, .dwf-current-attribute-name {\n  white-space: nowrap;\n  overflow: hidden;\n}\n\n.dwf-current-attribute-name {\n  text-overflow: ellipsis;\n  padding-left: var(--ha-space-4, 16px);\n  flex: 1;\n}\n\n.forecast-condition {\n  text-align: center;\n  font-weight: var(--ha-font-weight-bold, bold);\n  padding: var(--ha-space-2, 8px) var(--ha-space-4, 16px);\n  font-size: var(--ha-font-size-m, 14px);\n  color: var(--primary-text-color, #212121);\n}\n\n.compact-header {\n  --icon-size: 60px;\n  --icon-container-width: 60px;\n  color: var(--primary-text-color);\n  flex-direction: column;\n  display: flex;\n}\n\n.compact-header .current-conditions {\n  padding: var(--ha-space-4, 16px);\n  justify-content: space-between;\n  align-items: center;\n  display: flex;\n}\n\n.compact-header .has-action {\n  cursor: pointer;\n}\n\n.compact-header .condition {\n  font-size: var(--ha-font-size-xl, 20px);\n  font-weight: var(--ha-font-weight-normal, 400);\n  text-align: center;\n}\n\n.compact-header .weather-icon {\n  width: var(--icon-container-width);\n  justify-content: center;\n  display: flex;\n}\n\n.compact-header .weather-icon ha-icon {\n  --mdc-icon-size: var(--icon-size);\n}\n\n.compact-header .temperature {\n  font-size: var(--ha-font-size-2xl, 24px);\n  font-weight: var(--ha-font-weight-normal, 400);\n}\n\n.compact-header .nowcast-panel {\n  padding: 0 var(--ha-space-4, 16px);\n  flex-direction: column;\n  flex: auto;\n  min-height: 0;\n  display: flex;\n}\n\n.compact-header dwf-nowcast {\n  flex-direction: column;\n  flex: auto;\n  gap: 0;\n  width: 100%;\n  min-width: 0;\n  height: 100%;\n  min-height: 0;\n  display: flex;\n  overflow: hidden;\n}\n\n.compact-header .nowcast-bars {\n  align-items: stretch;\n  gap: var(--dwf-nowcast-gap, 5px);\n  flex: auto;\n  min-height: 24px;\n  display: flex;\n}\n\n.compact-header .nowcast-bar {\n  background: #0000000d;\n  border-radius: 999px;\n  flex: 1 1 0;\n  align-self: stretch;\n  align-items: flex-end;\n  height: auto;\n  min-height: 6px;\n  display: flex;\n  overflow: hidden;\n}\n\n.compact-header .nowcast-bar-fill {\n  background: var(--dwf-nowcast-fill-color, #4aafff);\n  border-radius: inherit;\n  width: 100%;\n  height: 0%;\n  transition: height .35s;\n}\n\n.compact-header .nowcast-labels {\n  font-size: var(--ha-font-size-s);\n  color: var(--primary-text-color);\n  will-change: transform;\n  justify-content: space-between;\n  transition: transform .35s;\n  display: flex;\n}\n";



var $b25jb = parcelRequire("b25jb");
class $1f5538121fe24449$export$3b85b111a7136eda extends (0, $eGUNk.LitElement) {
    static{
        this.styles = (0, $fLmsG.css)`
    ${(0, $fLmsG.unsafeCSS)($d7003433b68fc15c$exports.default || $d7003433b68fc15c$exports)}
  `;
    }
    _handleTemperatureClick() {
        this.dispatchEvent(new CustomEvent('dwf-temperature-click'));
    }
    _handleConditionClick() {
        this.dispatchEvent(new CustomEvent('dwf-condition-click'));
    }
    _handleTemperatureKeydown(ev) {
        if (ev.key === 'Enter' || ev.key === ' ') this._handleTemperatureClick();
    }
    _handleConditionKeydown(ev) {
        if (ev.key === 'Enter' || ev.key === ' ') this._handleConditionClick();
    }
    render() {
        if (!this.weatherEntity || !this.hass || !this.config) return 0, $l56HR.nothing;
        let headerCondition = undefined;
        const hasTemperatureTapAction = (0, $ee1328194d522913$export$e217e69099d082f5)(this.config.header_tap_action_temperature);
        const hasConditionTapAction = this.config.header_info.length > 0;
        if (this.weatherEntity.attributes['pictocode'] !== undefined) headerCondition = (0, $b25jb.localize)(`card.pictocode_hour.${this.weatherEntity.attributes['pictocode']}`);
        else headerCondition = this.hass?.formatEntityState?.(this.weatherEntity) || this.weatherEntity.state;
        return (0, $l56HR.html)`
      <div class="compact-header">
        <div class="current-conditions">
          ...
          >
            ${(0, $7Yo7j.getCurrentWeatherStateIcon)(this.weatherEntity, this, !this.isDaytime, this.config.icon_map)}
          </div>
          <div
            class=${(0, $ca7e425cc484d5ff$export$56cc687933817664)({
            condition: true,
        ...
        ${this.nowcastPanelTemplate ? (0, $l56HR.html)`<div class="nowcast">${this.nowcastPanelTemplate}</div>` : (0, $l56HR.nothing)}
...
], $1f5538121fe24449$export$3b85b111a7136eda.prototype, "hass", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $1f5538121fe24449$export$3b85b111a7136eda.prototype, "weatherEntity", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $1f5538121fe24449$export$3b85b111a7136eda.prototype, "config", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        attribute: false
    })
], $1f5538121fe24449$export$3b85b111a7136eda.prototype, "nowcastPanelTemplate", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)()
], $1f5538121fe24449$export$3b85b111a7136eda.prototype, "headerTemperature", void 0);
(0, $39J5i.__decorate)([
    (0, $cl6VG.property)({
        type: Boolean
    })
], $1f5538121fe24449$export$3b85b111a7136eda.prototype, "isDaytime", void 0);
customElements.define('dwf-compact-header', $1f5538121fe24449$export$3b85b111a7136eda);
...
$b817a793f979c482$exports = "ha-card {\n  flex-direction: column;\n  height: 100%;\n  display: flex;\n  overflow: hidden;\n}\n\n.weather {\n  width: 100%;\n  min-height: var(--dwf-header-height, calc(2.3 * var(--row-height, 56px)));\n  border-top-left-radius: var(--ha-card-border-radius, 12px);\n  border-top-right-radius: var(--ha-card-border-radius, 12px);\n  color: #fff;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  flex-direction: column;\n  flex-shrink: 0;\n  display: flex;\n}\n\n.weather.header-only {\n  border-bottom-left-radius: var(--ha-card-border-radius, 12px);\n  border-bottom-right-radius: var(--ha-card-border-radius, 12px);\n  flex: auto;\n  height: 100%;\n}\n\n.weather .header-content {\n  padding-block: var(--dwf-header-padding-block, 16px);\n  padding-inline: var(--dwf-header-padding-inline, 16px);\n  gap: var(--dwf-header-content-gap, 12px);\n  box-sizing: border-box;\n  flex-direction: column;\n  flex: auto;\n  width: 100%;\n  min-width: 0;\n  display: flex;\n}\n\n.weather .header-layout {\n  flex-direction: row;\n  flex: none;\n  justify-content: flex-start;\n  align-items: stretch;\n  gap: 0;\n  width: 100%;\n  min-width: 0;\n  display: flex;\n}\n\n.weather .header-main {\n  padding-left: var(--dwf-header-columns-gap, 16px);\n  justify-content: space-between;\n  align-items: flex-end;\n  gap: var(--dwf-header-main-gap, 10px);\n  flex-direction: column;\n  flex: 0 auto;\n  align-self: stretch;\n  min-width: 0;\n  min-height: 0;\n  margin-left: auto;\n  display: flex;\n}\n\n.weather .header-attributes {\n  justify-content: space-between;\n  gap: var(--dwf-header-attribute-gap, 8px);\n  flex-direction: column;\n  flex: 1 1 0;\n  align-self: stretch;\n  min-width: 30%;\n  min-height: 0;\n  display: flex;\n}\n\n.weather .attribute-chip {\n  font-size: var(--ha-font-size-m);\n  line-height: calc(6px + var(--ha-font-size-m));\n  padding: var(--ha-space-1, 4px) var(--ha-space-3, 12px);\n  color: inherit;\n  background-color: #00000059;\n  border-radius: 25px;\n  align-self: flex-start;\n  align-items: center;\n  min-width: 0;\n  max-width: 100%;\n  display: inline-flex;\n  overflow: hidden;\n}\n\n.weather .attribute-chip .chip-icon {\n  --mdc-icon-size: 20px;\n  color: inherit;\n  margin-right: 6px;\n}\n\n.weather .attribute-chip.has-action {\n  cursor: pointer;\n}\n\n.weather .attribute-chip.has-action:focus-visible {\n  outline-offset: 2px;\n  outline: 2px solid #ffffffe6;\n}\n\n.weather .attribute-chip.missing {\n  opacity: .8;\n  font-style: italic;\n}\n\n.weather .condition {\n  font-size: var(--ha-font-size-xl);\n  line-height: calc(10px + var(--ha-font-size-xl));\n  padding: var(--ha-space-1, 4px) var(--ha-space-4, 16px);\n  background-color: #0000004d;\n  border-radius: 25px;\n  justify-content: center;\n  align-items: center;\n  min-width: 0;\n  max-width: 70%;\n  display: inline-flex;\n  overflow: hidden;\n}\n\n.weather .temp.has-action, .weather .condition.has-action {\n  cursor: pointer;\n}\n\n.weather .temp.has-action:focus-visible, .weather .condition.has-action:focus-visible {\n  outline-offset: 2px;\n  outline: 2px solid #ffffffe6;\n}\n\n.weather .temp {\n  font-size: var(--ha-font-size-5xl);\n  line-height: calc(10px + var(--ha-font-size-xl));\n  font-weight: var(--ha-font-weight-bold, bold);\n  padding: 2px var(--ha-space-4, 16px);\n  background-color: #0000004d;\n  border-radius: 25px;\n  justify-content: center;\n  align-items: center;\n  min-width: 0;\n  max-width: 100%;\n  display: inline-flex;\n  overflow: hidden;\n}\n\n.weather .header-pill-text {\n  white-space: normal;\n  flex: 0 auto;\n  min-width: 0;\n}\n\n.weather .nowcast-panel {\n  padding: var(--ha-space-3, 12px) var(--ha-space-3, 12px) 6px var(--ha-space-3, 12px);\n  background: #0000004d;\n  border-radius: 16px;\n  flex-direction: column;\n  flex: auto;\n  min-height: 0;\n  display: flex;\n}\n\n.weather dwf-nowcast {\n  flex-direction: column;\n  flex: auto;\n  gap: 0;\n  width: 100%;\n  min-width: 0;\n  height: 100%;\n  min-height: 0;\n  display: flex;\n  overflow: hidden;\n}\n\n.weather .nowcast-bars {\n  align-items: stretch;\n  gap: var(--dwf-nowcast-gap, 5px);\n  flex: auto;\n  min-height: 24px;\n  display: flex;\n}\n\n.weather .nowcast-bar {\n  background: #ffffff06;\n  border-radius: 999px;\n  flex: 1 1 0;\n  align-self: stretch;\n  align-items: flex-end;\n  height: auto;\n  min-height: 6px;\n  display: flex;\n  overflow: hidden;\n}\n\n.weather .nowcast-bar-fill {\n  background: var(--dwf-nowcast-fill-color, #4aafff);\n  border-radius: inherit;\n  width: 100%;\n  height: 0%;\n  transition: height .35s;\n}\n\n@media (prefers-reduced-motion: reduce) {\n  .weather .nowcast-bar-fill, .weather .nowcast-labels {\n    transition: none;\n  }\n}\n\n.weather .nowcast-labels {\n  font-size: var(--ha-font-size-s);\n  color: #fff;\n  will-change: transform;\n  justify-content: space-between;\n  transition: transform .35s;\n  display: flex;\n}\n\n.forecast-container {\n  width: 100%;\n  padding-top: var(--ha-space-1, 4px);\n  padding-bottom: var(--ha-space-5, 20px);\n  flex-direction: column;\n  flex: 0 auto;\n  gap: 4px;\n  display: flex;\n}\n\n.divider {\n  background-color: var(--primary-background-color);\n}\n\n.card-divider {\n  height: 4px;\n}\n\n.forecast-divider {\n  border-radius: 2px;\n}\n\n.forecast-container > .forecast-divider {\n  height: 4px;\n  margin: 14px 16px 4px;\n}\n\n.forecast-daily-container, .forecast-hourly-container {\n  touch-action: pan-x;\n  overscroll-behavior-x: contain;\n  flex-direction: column;\n  flex: 0 auto;\n  justify-content: flex-start;\n  display: flex;\n  position: relative;\n  overflow: hidden;\n}\n\n.fade-left, .fade-right {\n  pointer-events: none;\n  z-index: 2;\n  width: 16px;\n  position: absolute;\n  top: 0;\n  bottom: 0;\n}\n\n.fade-left {\n  background: linear-gradient(to right,\n    var(--card-background-color) 0%,\n    var(--card-background-color) 2px,\n    transparent 100%);\n  left: 0;\n}\n\n.fade-right {\n  background: linear-gradient(to left,\n    var(--card-background-color) 0%,\n    var(--card-background-color) 2px,\n    transparent 100%);\n  right: 0;\n}\n\n.forecast {\n  --forecast-inline-padding: 16px;\n  scroll-snap-type: x mandatory;\n  height: auto;\n  scroll-padding-left: var(--forecast-inline-padding);\n  scroll-padding-right: var(--forecast-inline-padding);\n  justify-content: space-around;\n  align-items: stretch;\n  gap: var(--dynamic-gap, 20px);\n  padding: var(--ha-space-2, 8px) var(--forecast-inline-padding) 0px;\n  flex: 0 auto;\n  display: flex;\n  overflow: auto clip;\n}\n\n@supports (-webkit-touch-callout: none) {\n  .forecast {\n    padding-bottom: var(--ha-space-3, 12px);\n  }\n}\n\n.forecast dwf-daily-list, .forecast dwf-hourly-list {\n  display: contents;\n}\n\n.forecast.daily {\n  --min-gap: 30px;\n  --icon-size: 60px;\n  --icon-container-width: 60px;\n  cursor: grab;\n  -webkit-user-select: none;\n  user-select: none;\n}\n\n.forecast.hourly {\n  --min-gap: 16px;\n  --icon-size: 60px;\n  --icon-container-width: 60px;\n  --day-marker-width: 60px;\n  cursor: grab;\n  -webkit-user-select: none;\n  user-select: none;\n  padding-top: 32px;\n}\n\n.forecast.hourly.dragging, .forecast.hourly.momentum, .forecast.daily.dragging, .forecast.daily.momentum {\n  scroll-snap-type: none;\n}\n\n.forecast.hourly.grabbing, .forecast.daily.grabbing {\n  cursor: grabbing;\n}\n\n.forecast::-webkit-scrollbar {\n  height: 0;\n}\n\n.forecast::-webkit-scrollbar-thumb {\n  background: none;\n}\n\n.forecast::-webkit-scrollbar-track {\n  background: none;\n}\n\n.forecast::-webkit-scrollbar-corner {\n  background: none;\n}\n\n.forecast {\n  -ms-overflow-style: none;\n  scrollbar-width: none;\n}\n\n.forecast::-webkit-scrollbar {\n  display: none;\n}\n\n.forecast-item {\n  scroll-snap-align: start;\n  text-align: center;\n  cursor: pointer;\n  flex-direction: column;\n  height: 100%;\n  display: flex;\n}\n\n.forecast.hourly .forecast-item {\n  width: var(--icon-container-width);\n  align-items: center;\n  overflow: visible;\n}\n\n.forecast.hourly .day-marker {\n  --day-marker-translate-x: calc((var(--dynamic-gap, 20px) + var(--icon-container-width) - var(--day-marker-width)) / 2);\n  left: calc((((var(--day-marker-width) - var(--icon-container-width)) / 2) * -1) - var(--day-marker-translate-x));\n  transform: translateX(var(--day-marker-translate-x)) translateY(-100%);\n  font-weight: var(--ha-font-weight-bold, bold);\n  color: #fff;\n  background-color: var(--state-climate-cool-color);\n  pointer-events: none;\n  white-space: nowrap;\n  z-index: 3;\n  scroll-snap-align: none;\n  width: var(--day-marker-width);\n  margin-right: calc(var(--day-marker-width) * -1 - var(--dynamic-gap) / 2);\n  margin-right: calc(round(up, var(--day-marker-width) * -1 - var(--dynamic-gap) / 2, 1px));\n  margin-left: calc(var(--dynamic-gap) * -1 / 2);\n  border-radius: 999px;\n  flex: none;\n  justify-content: center;\n  align-self: start;\n  align-items: center;\n  display: inline-flex;\n  position: sticky;\n}\n\n.forecast .day-of-month {\n  opacity: .3;\n  margin-top: -4px;\n  font-size: 13px;\n}\n\n.forecast .date.sunrise {\n  color: var(--orange-color, #ff9800);\n  font-weight: var(--ha-font-weight-medium, 500);\n}\n\n.forecast .date.sunset {\n  color: var(--purple-color, #926bc7);\n  font-weight: var(--ha-font-weight-medium, 500);\n}\n\n.forecast.daily .date.selected {\n  background-color: var(--state-climate-cool-color);\n  color: #fff;\n  border-radius: 999px;\n}\n\n.forecast.hourly .date {\n  width: var(--icon-container-width);\n  text-align: center;\n  white-space: nowrap;\n  justify-content: center;\n  align-items: center;\n  margin: 0 auto;\n  display: flex;\n}\n\n.forecast.hourly .date.selected {\n  background-color: var(--state-climate-cool-color);\n  color: #fff;\n  border-radius: 999px;\n}\n\n.forecast .ampm {\n  opacity: .3;\n  font-size: 11px;\n}\n\n.forecast .temp {\n  font-size: var(--ha-font-size-xl);\n  font-weight: var(--ha-font-weight-bold, bold);\n}\n\n.forecast .templow {\n  opacity: .5;\n  font-weight: var(--ha-font-weight-bold, bold);\n  font-size: var(--ha-font-size-l);\n}\n\n.forecast .precipitation, .forecast .precipitationprobability {\n  opacity: .3;\n  color: var(--state-climate-cool-color);\n  min-height: 20px;\n}\n\n.forecast .hourly-extra {\n  opacity: .6;\n  color: var(--primary-text-color);\n  min-height: 20px;\n  font-weight: var(--ha-font-weight-medium, 500);\n  white-space: nowrap;\n}\n\n.forecast .hourly-extra.dimmed {\n  opacity: .3;\n}\n\n.forecast .precipitation {\n  --precipitation-fill: 0%;\n  --dwf-precipitation-indicator-color: var(--state-climate-cool-color);\n  --dwf-precipitation-indicator-opacity: .2;\n  --dwf-precipitation-indicator-padding-inline: 8px;\n  --dwf-precipitation-indicator-padding-block: 0px;\n  --dwf-precipitation-indicator-offset-top: 0px;\n  --dwf-precipitation-indicator-offset-bottom: 0px;\n  padding-inline: var(--dwf-precipitation-indicator-padding-inline);\n  padding-block: var(--dwf-precipitation-indicator-padding-block);\n  border-radius: var(--dwf-precipitation-indicator-radius, 4px);\n  z-index: 0;\n  display: inline-block;\n  position: relative;\n  overflow: hidden;\n}\n\n.forecast .precipitation:before {\n  content: \"\";\n  inset-inline: 0;\n  top: calc(100% - var(--precipitation-fill, 0%) - var(--dwf-precipitation-indicator-offset-top, 0px));\n  bottom: calc(0px - var(--dwf-precipitation-indicator-offset-bottom, 0px));\n  background-color: var(--dwf-precipitation-indicator-color, var(--state-climate-cool-color));\n  opacity: var(--dwf-precipitation-indicator-opacity, .2);\n  border-radius: inherit;\n  pointer-events: none;\n  z-index: -1;\n  transition: top .15s ease-in-out, background-color .15s ease-in-out;\n  position: absolute;\n}\n\n.forecast .precipitation.overflow {\n  --dwf-precipitation-indicator-color: var(--red-color, #f44336);\n  color: var(--red-color, #f44336);\n}\n\n.forecast.daily .forecast-item > .precipitation {\n  line-height: 18px;\n}\n\n.forecast .precipitation.active, .forecast .precipitationprobability.active {\n  opacity: 1;\n}\n\n.forecast .daily-extra {\n  opacity: .6;\n  color: var(--primary-text-color);\n  min-height: 20px;\n  font-weight: var(--ha-font-weight-medium, 500);\n  white-space: nowrap;\n}\n\n.forecast .daily-extra.dimmed {\n  opacity: .3;\n}\n\n.forecast.daily .daily-extra.precipitationprobability {\n  color: var(--state-climate-cool-color);\n  opacity: .3;\n  display: block !important;\n}\n\n.forecast .daily-extra.precipitationprobability.active {\n  opacity: 1;\n}\n\n.forecast.daily .forecast-item {\n  grid-auto-rows: max-content;\n  align-content: start;\n  display: grid;\n}\n\n.forecast.daily .forecast-item > .date, .forecast.daily .forecast-item > .day-of-month, .forecast.daily .forecast-item > .precipitation, .forecast.daily .forecast-item > .precipitationprobability, .forecast.daily .forecast-item > .daily-extra {\n  min-height: auto;\n}\n\n.forecast.daily .forecast-item > .date {\n  grid-row: 1;\n}\n\n.forecast.daily .forecast-item > .day-of-month {\n  grid-row: 2;\n}\n\n.forecast.daily .forecast-item > .forecast-image-icon {\n  grid-row: 3;\n}\n\n.forecast.daily .forecast-item > .temp {\n  grid-row: 4;\n}\n\n.forecast.daily .forecast-item > .templow {\n  grid-row: 5;\n}\n\n.forecast.daily .forecast-item > .precipitation {\n  grid-row: 6;\n}\n\n.forecast.daily .forecast-item > .precipitationprobability {\n  grid-row: 7;\n}\n\n.forecast.daily .forecast-item > .daily-extra {\n  text-align: center;\n  width: var(--icon-size);\n  grid-row: 8;\n  justify-self: center;\n}\n\n.forecast-image-icon {\n  justify-content: center;\n  display: flex;\n}\n\n.forecast-image-icon > * {\n  width: var(--icon-size);\n  height: var(--icon-size);\n}\n\n.forecast-image-icon ha-icon {\n  --mdc-icon-size: var(--icon-size);\n}\n\n.rain {\n  fill: var(--weather-icon-rain-color, #30b3ff);\n}\n\n.sun {\n  fill: var(--weather-icon-sun-color, #fdd93c);\n}\n\n.moon {\n  fill: var(--weather-icon-moon-color, #fcf497);\n}\n\n.cloud-back {\n  fill: var(--weather-icon-cloud-back-color, #d4d4d4);\n}\n\n.cloud-front {\n  fill: var(--weather-icon-cloud-front-color, #f9f9f9);\n}\n\n.snow {\n  fill: var(--weather-icon-snow-color, #f9f9f9);\n  stroke: var(--weather-icon-snow-stroke-color, #d4d4d4);\n  stroke-width: 1px;\n  paint-order: stroke;\n}\n\ndwf-current-weather-attributes {\n  display: contents;\n}\n\n.dwf-current-attributes {\n  gap: var(--ha-space-1, 4px);\n  min-width: 0;\n  padding: var(--ha-space-2, 8px) var(--ha-space-4, 16px);\n  flex-direction: column;\n  display: flex;\n}\n\n.dwf-current-attribute {\n  justify-content: space-between;\n  align-items: center;\n  gap: var(--ha-space-1, 4px);\n  font-size: var(--ha-font-size-m, 14px);\n  line-height: var(--ha-line-height-condensed);\n  color: var(--primary-text-color, #212121);\n  white-space: nowrap;\n  flex-direction: row;\n  display: flex;\n}\n\n.dwf-current-attribute.has-action {\n  cursor: pointer;\n}\n\n.dwf-current-attribute-icon {\n  color: var(--state-icon-color, #616161);\n  padding-left: var(--ha-space-2, 8px);\n}\n\n.dwf-current-attribute-value, .dwf-current-attribute-name {\n  white-space: nowrap;\n  overflow: hidden;\n}\n\n.dwf-current-attribute-name {\n  text-overflow: ellipsis;\n  padding-left: var(--ha-space-4, 16px);\n  flex: 1;\n}\n\n.forecast-condition {\n  text-align: center;\n  font-weight: var(--ha-font-weight-bold, bold);\n  padding: var(--ha-space-2, 8px) var(--ha-space-4, 16px);\n  font-size: var(--ha-font-size-m, 14px);\n  color: var(--primary-text-color, #212121);\n}\n\n.compact-header {\n  --icon-size: 60px;\n  --icon-container-width: 60px;\n  color: var(--primary-text-color);\n  flex-direction: column;\n  display: flex;\n}\n\n.compact-header .current-conditions {\n  padding: var(--ha-space-4, 16px);\n  justify-content: space-between;\n  align-items: center;\n  display: flex;\n}\n\n.compact-header .has-action {\n  cursor: pointer;\n}\n\n.compact-header .condition {\n  font-size: var(--ha-font-size-xl, 20px);\n  font-weight: var(--ha-font-weight-normal, 400);\n  text-align: center;\n}\n\n.compact-header .weather-icon {\n  width: var(--icon-container-width);\n  justify-content: center;\n  display: flex;\n}\n\n.compact-header .weather-icon ha-icon {\n  --mdc-icon-size: var(--icon-size);\n}\n\n.compact-header .temperature {\n  font-size: var(--ha-font-size-2xl, 24px);\n  font-weight: var(--ha-font-weight-normal, 400);\n}\n\n.compact-header .nowcast-panel {\n  padding: 0 var(--ha-space-4, 16px);\n  flex-direction: column;\n  flex: auto;\n  min-height: 0;\n  display: flex;\n}\n\n.compact-header dwf-nowcast {\n  flex-direction: column;\n  flex: auto;\n  gap: 0;\n  width: 100%;\n  min-width: 0;\n  height: 100%;\n  min-height: 0;\n  display: flex;\n  overflow: hidden;\n}\n\n.compact-header .nowcast-bars {\n  align-items: stretch;\n  gap: var(--dwf-nowcast-gap, 5px);\n  flex: auto;\n  min-height: 24px;\n  display: flex;\n}\n\n.compact-header .nowcast-bar {\n  background: #0000000d;\n  border-radius: 999px;\n  flex: 1 1 0;\n  align-self: stretch;\n  align-items: flex-end;\n  height: auto;\n  min-height: 6px;\n  display: flex;\n  overflow: hidden;\n}\n\n.compact-header .nowcast-bar-fill {\n  background: var(--dwf-nowcast-fill-color, #4aafff);\n  border-radius: inherit;\n  width: 100%;\n  height: 0%;\n  transition: height .35s;\n}\n\n.compact-header .nowcast-labels {\n  font-size: var(--ha-font-size-s);\n  color: var(--primary-text-color);\n  will-change: transform;\n  justify-content: space-between;\n  transition: transform .35s;\n  display: flex;\n}\n";
...
const $04b2058bf019e2da$var$cloudyConditionImage = new URL("cloudy.d9fe5ef3.jpg", import.meta.url).href;
const $04b2058bf019e2da$var$cloudyNightConditionImage = new URL("cloudy-night.3c087f91.jpg", import.meta.url).href;
...
const $04b2058bf019e2da$var$partlyCloudyNightConditionImage = new URL("partly-cloudy-night.1b74815d.jpg", import.meta.url).href;
...
const $04b2058bf019e2da$var$lightningRainyConditionImage = new URL("lightning-rainy.207e6de4.jpg", import.meta.url).href;
const $04b2058bf019e2da$var$lightningRainyNightConditionImage = new URL("lightning-rainy-night.7bb6ca13.jpg", import.meta.url).href;
const $04b2058bf019e2da$var$lightningConditionImage = new URL("lightning.36584782.jpg", import.meta.url).href;
const $04b2058bf019e2da$var$lightningNightConditionImage = new URL("lightning-night.220aa10f.jpg", import.meta.url).href;
...
const $04b2058bf019e2da$var$snowyRainyNightConditionImage = new URL("snowy-rainy-night.3afa6ed4.jpg", import.meta.url).href;
...
const $04b2058bf019e2da$var$windyVariantNightConditionImage = new URL("windy-variant-night.efb03746.jpg", import.meta.url).href;
...
const $04b2058bf019e2da$export$d0bd520bd5ddb657 = {
    ...
    cloudy: {
        day: $04b2058bf019e2da$var$cloudyConditionImage,
        night: $04b2058bf019e2da$var$cloudyNightConditionImage
    },
    partlycloudy: {
...
class $4823e4ad7ec1951b$export$adb56434d0008518 extends (0, $eGUNk.LitElement) {
    ...
    _shouldApplyMasonryHeight() {
        ...
        return !Boolean(this.closest('hui-sections-view') || this.closest('hui-section-view') || this.closest('hui-section'));
    }
    _getHeaderChips() {
    ...
    render() {
      ...
      `;
        ...
        let headerCondition = undefined;
        if (this._state.attributes['pictocode'] !== undefined) headerCondition = (0, $b25jb.localize)(`card.pictocode_hour.${this._state.attributes['pictocode']}`);
        ...
        const showInlineNowcast = nowcastEnabled && (this._config.nowcast_always_show || this._nowcastHasRain || headerOnly);
        ...
        const headerChipsTemplate = headerChips.length ? headerChips.map((chip)=>{
            ...
            <div
              ...
              @click=${hasChipAction ? ()=>this._handleHeaderChipTap(chip.action, chip.type === 'entity' ? chip.entity : undefined) : undefined}
              @keydown=${hasChipAction ? (ev)=>this._handleHeaderChipKeydown(ev, chip.action, chip.type === 'entity' ? chip.entity : undefined) : undefined}
            >
        ...
        const headerAttributesTemplate = headerChips.length ? (0, $l56HR.html)` <div class="header-attributes">${headerChipsTemplate}</div> ` : (0, $l56HR.nothing);
    ...
    `;
      ...
      <div
        class="nowcast-panel"
        style=${useSnowNowcastFill ? (0, $2e9FX.styleMap)({
    ...
    `;
      ...
      <ha-card style=${cardStyle}>
        ${showHeader ? this._config.compact_header ? (0, $l56HR.html)`
                <dwf-compact-header
                  .hass=${this._hass}
        ...
        ${this._config.header_info.length > 0 && this._showAttributes ? (0, $l56HR.html)`<dwf-current-weather-attributes
                .hass=${this._hass}
                .weatherEntity=${this._state}
                .attributeConfigs=${this._config.header_info}
              ></dwf-current-weather-attributes>
              <div class="divider card-divider"></div>` : (0, $l56HR.nothing)}
        ${showForecasts ? (0, $l56HR.html)`
              <div class="forecast-container">
                ${dailyEnabled ? (0, $l56HR.html)`
                    ...
                    ` : (0, $l56HR.nothing)}
                ${this._selectedDailyForecast && this._config.daily_info.length > 0 ? (0, $l56HR.html)`<div class="divider card-divider"></div>
                      <dwf-forecast-attributes
                        ...
                        .dailyForecast=${true}
                      ></dwf-forecast-attributes>` : (0, $l56HR.nothing)}
            ...
            ` : (0, $l56HR.nothing)}
        ${this._selectedHourlyForecast && this._config.hourly_info.length > 0 ? (0, $l56HR.html)`<div class="divider card-divider"></div>
              <dwf-forecast-attributes
                .hass=${this._hass}
                .weatherEntity=${this._state}
    ...
    _formatHeaderAttribute(attribute, unit, divisor) {
        ...
        if (typeof rawValue === 'number') {
            ...
            } else display = rawValue.toLocaleString(this.hass?.locale?.language, {
                maximumFractionDigits: 1
            });
        } else if (typeof rawValue === 'string') {
            const trimmed = rawValue.trim();
        ...
        const resolvedValue = formattedValue !== undefined && formattedValue !== null && formattedValue !== '' ? formattedValue : display;
    ...
    _needsSolarForecast() {
        ...
        return this._config.hourly_extra_attribute === $4823e4ad7ec1951b$var$SOLAR_FORECAST_ATTRIBUTE || this._config.daily_extra_attribute === $4823e4ad7ec1951b$var$SOLAR_FORECAST_ATTRIBUTE || this._config.hourly_info.some((info)=>info.attribute === $4823e4ad7ec1951b$var$SOLAR_FORECAST_ATTRIBUTE) || this._config.daily_info.some((info)=>info.attribute === $4823e4ad7ec1951b$var$SOLAR_FORECAST_ATTRIBUTE);
    }
    ...
    _handleCompactHeaderTemperatureClick() {
        const temperatureTapAction = this._config.header_tap_action_temperature;
        const temperatureActionEntity = this._config.header_temperature_entity || this._entity;
    ...
    constructor(...args){
        super(...args), this._solarForecastByHour = {}, this._solarForecastByDay = {}, this._nowcastForecast = [], this._nowcastHasRain = false, this._showAttributes = false, // private property
        this._subscriptions = {
            hourly: undefined,
            daily: undefined
        }, this._momentumCleanup = {}, this._momentumElement = {}, this._solarForecastRequestId = 0, this._nowcastRequestId = 0, this._isProgrammaticScroll = false;
    }
}
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_config", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_entity", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_name", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_state", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_status", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_headerTemperatureState", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_forecastDailyEvent", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_forecastHourlyEvent", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_dailyGap", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_hourlyGap", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_solarForecastByHour", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_solarForecastByDay", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_nowcastForecast", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_nowcastHasRain", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_showAttributes", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_selectedHourlyForecast", void 0);
(0, $39J5i.__decorate)([
    (0, $ithOD.state)()
], $4823e4ad7ec1951b$export$adb56434d0008518.prototype, "_selectedDailyForecast", void 0);
