...
parcelRegister('JMs79', function (module, exports) {
  ...
  const $112bd870a911c060$var$HEADER_CHIP_INDEXES = [0, 1, 2];
  const $112bd870a911c060$var$chipTypeFieldName = (index) => `header_chip_${index + 1}_type`;
  const $112bd870a911c060$var$chipAttributeFieldName = (index) => `header_chip_${index + 1}_attribute`;
  const $112bd870a911c060$var$chipEntityFieldName = (index) => `header_chip_${index + 1}_entity`;
  const $112bd870a911c060$var$chipIconFieldName = (index) => `header_chip_${index + 1}_icon`;
  const $112bd870a911c060$var$chipActionFieldName = (index) => `header_chip_${index + 1}_tap_action`;
  const $112bd870a911c060$var$chipUnitFieldName = (index) => `header_chip_${index + 1}_unit`;
  const $112bd870a911c060$var$chipDivisorFieldName = (index) => `header_chip_${index + 1}_divisor`;
  const $112bd870a911c060$var$CHIP_FORM_FIELD_NAMES = $112bd870a911c060$var$HEADER_CHIP_INDEXES.reduce(
    (names, index) => {
      names.push(
        $112bd870a911c060$var$chipTypeFieldName(index),
        $112bd870a911c060$var$chipAttributeFieldName(index),
        $112bd870a911c060$var$chipEntityFieldName(index),
        $112bd870a911c060$var$chipIconFieldName(index),
        $112bd870a911c060$var$chipActionFieldName(index),
        $112bd870a911c060$var$chipUnitFieldName(index),
        $112bd870a911c060$var$chipDivisorFieldName(index),
      );
      return names;
    },
    [],
  );
  const $112bd870a911c060$var$CHIP_TYPE_OPTIONS = [
    {
      value: 'attribute',
      label: (0, $b25jb.localize)('editor.chip.attribute', '', ''),
    },
    {
      value: 'entity',
      label: (0, $b25jb.localize)('editor.chip.entity', '', ''),
    },
  ];
  ...
  `;
    ...
    _handleValueChanged(event) {
      ...
      $112bd870a911c060$var$HEADER_CHIP_INDEXES.forEach((index) => {
        const typeField = $112bd870a911c060$var$chipTypeFieldName(index);
      ...
      $112bd870a911c060$var$CHIP_FORM_FIELD_NAMES.forEach((name) => {
    ...
    _createFormData() {
      ...
      $112bd870a911c060$var$HEADER_CHIP_INDEXES.forEach((index) => {
        const typeField = $112bd870a911c060$var$chipTypeFieldName(index);
        const attributeField = $112bd870a911c060$var$chipAttributeFieldName(index);
        const entityField = $112bd870a911c060$var$chipEntityFieldName(index);
        const iconField = $112bd870a911c060$var$chipIconFieldName(index);
        const actionField = $112bd870a911c060$var$chipActionFieldName(index);
        const unitField = $112bd870a911c060$var$chipUnitFieldName(index);
        const divisorField = $112bd870a911c060$var$chipDivisorFieldName(index);
    ...
    _buildSchemas() {
      ...
      $112bd870a911c060$var$HEADER_CHIP_INDEXES.forEach((index) => {
        ...
        chipsSchema.push({
          ...
          selector: {
            select: {
              options: $112bd870a911c060$var$CHIP_TYPE_OPTIONS,
            },
          },
          optional: true,
        });
        ...
        if (chipType === 'entity')
          chipsSchema.push({
            name: $112bd870a911c060$var$chipEntityFieldName(index),
            selector: {
              entity: {},
            },
            optional: true,
          ...
          chipsSchema.push({
            name: $112bd870a911c060$var$chipAttributeFieldName(index),
            selector: {
              select: {
          ...
          chipsSchema.push({
            name: $112bd870a911c060$var$chipUnitFieldName(index),
            selector: {
              text: {},
            },
            optional: true,
          ...
          chipsSchema.push({
            name: $112bd870a911c060$var$chipDivisorFieldName(index),
            selector: {
              text: {},
            },
            optional: true,
        ...
        chipsSchema.push({
          name: $112bd870a911c060$var$chipIconFieldName(index),
          selector: {
            icon: {},
          },
          optional: true,
        ...
        chipsSchema.push({
          name: $112bd870a911c060$var$chipActionFieldName(index),
          selector: {
            ui_action: {},
          },
          optional: true,
    ...
    _normalizeHeaderChips(config) {
      const limit = $112bd870a911c060$var$HEADER_CHIP_INDEXES.length;
      const normalized = [];
    ...
    _buildChipTypeState(chips) {
      ...
      chips.slice(0, $112bd870a911c060$var$HEADER_CHIP_INDEXES.length).forEach((chip, index) => {
      ...
      super(...args),
        ...
        (this._computeLabel = (schema) => {
          ...
          if (typeof schema.name === 'string' && schema.name.startsWith('header_chip_')) {
            ...
            return (0, $b25jb.localize)(`editor.main.header_chip.${key}`, '{index}', String(labelIndex));
          }
  ...
  (0,
  $39J5i.__decorate)([(0, $1ZxoT.state)()], $112bd870a911c060$export$4f33cd896d7e371b.prototype, '_chipTypes', void 0);
  (0,
...
//# sourceMappingURL=detailed-weather-forecast-editor.d7ba5911.js.map
