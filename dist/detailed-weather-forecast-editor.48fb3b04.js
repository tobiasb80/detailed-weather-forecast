...
class $112bd870a911c060$export$4f33cd896d7e371b extends (0, $j0ZcV.LitElement) {
  ...
  `;
    ...
    render() {
        ...
        const { general: generalSchema, header: headerSchema, nowcast: nowcastSchema, hourly: hourlySchema, daily: dailySchema } = this._buildSchemas();
      ...
      <div class="editor-section">
        ${this._renderExpander('gps-coordinates', (0, $b25jb.localize)('editor.section.gps_coordinates', '', ''), (0, $j0ZcV.html)`
            <p class="location-description">${(0, $b25jb.localize)('editor.section.gps_coordinates_description', '', '')}</p>
      ...
      <div class="editor-section">
        ${this._renderExpander('solar-forecast', (0, $b25jb.localize)('editor.section.solar_forecast', '', ''), (0, $j0ZcV.html)`
            <p class="location-description">${(0, $b25jb.localize)('editor.section.solar_forecast_description', '', '')}</p>
            <ha-selector
              .hass=${this.hass}
              .selector=${{
            select: {
            ...
            ></ha-selector>
            ${this._solarForecastOptionsLoaded && !this._solarForecastEntryIds.length ? (0, $j0ZcV.html)`<p class="location-description">
                  ${(0, $b25jb.localize)('editor.section.no_energy_solar_forecasts_configured', '', '')}
                </p>` : (0, $j0ZcV.nothing)}
          `)}
      </div>
      <div class="editor-section">
        ${this._renderExpander('custom-icons', (0, $b25jb.localize)('editor.section.custom_icons', '', ''), (0, $j0ZcV.html)`
            <p class="location-description">${(0, $b25jb.localize)('editor.section.custom_icons_description', '', '')}</p>
      ...
      <div class="editor-section">
        ${this._renderToggleExpander('header', (0, $b25jb.localize)('editor.section.header', '', ''), 'show_header', (0, $j0ZcV.html)`
            <ha-form
              .hass=${this.hass}
              .data=${formData}
              .schema=${headerSchema}
              ...
              @value-changed=${this._handleValueChanged}
            ></ha-form>
            ${this._renderExpander('header-chips', (0, $b25jb.localize)('editor.section.chips', '', ''), (0, $j0ZcV.html)`
                <p class="chips-hint">${(0, $b25jb.localize)('editor.section.chips_description', '', '')}</p>
                ${[
            0,
            1,
            2
        ].map((index)=>(0, $j0ZcV.html)`
            ...
            ${this._renderExpander('header-nowcast', (0, $b25jb.localize)('editor.section.nowcast', '', ''), (0, $j0ZcV.html)`
                <p class="location-description">${(0, $b25jb.localize)('editor.section.nowcast_description', '', '')}</p>
                <ha-form
                  .hass=${this.hass}
                  .data=${formData}
            ...
            ${this._renderExpander('header-info', (0, $b25jb.localize)('editor.section.header_info', '', ''), (0, $j0ZcV.html)`
                <p class="chips-hint">${(0, $b25jb.localize)('editor.section.header_info_description', '', '')}</p>
                ${this._config.header_info?.map((info, index)=>(0, $j0ZcV.html)`
      ...
      <div class="editor-section">
        ${this._renderToggleExpander('daily-forecast', (0, $b25jb.localize)('editor.section.daily_forecast', '', ''), 'daily_forecast', (0, $j0ZcV.html)`
            <ha-form
              .hass=${this.hass}
              .data=${formData}
              .schema=${dailySchema}
              ...
              @value-changed=${this._handleValueChanged}
            ></ha-form>
            ${this._forecastOptionsLoading.daily && !this._dailyExtraOptions.length ? (0, $j0ZcV.html)`<p class="location-description">${(0, $b25jb.localize)('editor.main.loading_forecast_attributes')}</p>` : (0, $j0ZcV.nothing)}
            <div class="sun-coordinates">
              <label class="coordinate-field">
            ...
            <div class="editor-subsection">
              ...
              <p class="location-description">${(0, $b25jb.localize)('editor.section.forecast_spacing_description', '', '')}</p>
              <div class="sun-coordinates">
                <label class="coordinate-field">
            ...
            ${this._renderExpander('daily-info', (0, $b25jb.localize)('editor.section.daily_forecast_info', '', ''), (0, $j0ZcV.html)`
                <p class="chips-hint">${(0, $b25jb.localize)('editor.section.daily_forecast_info_description', '', '')}</p>
                ${this._config.daily_info?.map((info, index)=>(0, $j0ZcV.html)`
      ...
      <div class="editor-section">
        ${this._renderToggleExpander('hourly-forecast', (0, $b25jb.localize)('editor.section.hourly_forecast', '', ''), 'hourly_forecast', (0, $j0ZcV.html)`
            <ha-form
              .hass=${this.hass}
              .data=${formData}
              .schema=${hourlySchema}
              ...
              @value-changed=${this._handleValueChanged}
            ></ha-form>
            ${this._forecastOptionsLoading.hourly && !this._hourlyExtraOptions.length ? (0, $j0ZcV.html)`<p class="location-description">${(0, $b25jb.localize)('editor.main.loading_forecast_attributes')}</p>` : (0, $j0ZcV.nothing)}
            <div class="sun-coordinates">
              <label class="coordinate-field">
                <span>${(0, $b25jb.localize)('editor.section.extra_attribute_color', '', '')}</span>
                <div class="color-input-row">
            ...
            ${this._renderExpander('hourly-info', (0, $b25jb.localize)('editor.section.hourly_forecast_info', '', ''), (0, $j0ZcV.html)`
                <p class="chips-hint">${(0, $b25jb.localize)('editor.section.hourly_forecast_info_description', '', '')}</p>
                ${this._config.hourly_info?.map((info, index)=>(0, $j0ZcV.html)`
                    <div class="forecast-info-item">
                      <forecast-attribute-editor
                        .hass=${this.hass}
                        .config=${info}
    ...
    _headerChipChanged(e, index) {
        ...
        while(newChips.length <= index)newChips.push({
            type: 'attribute',
            attribute: '',
            name: ''
        });
        ...
        while(newChips.length > 0){
            ...
            const isEmpty = lastChip.type === 'attribute' && !lastChip.attribute && !lastChip.name || lastChip.type === 'entity' && !lastChip.entity && !lastChip.name;
    ...
    _buildHourlyExtraAttributeOptions(includeDisallowed = false) {
        ...
        const options = this._hourlyExtraOptions.length ? this._hourlyExtraOptions.filter((opt)=>includeDisallowed || !disallowed.has(opt)) : [];
    ...
    _buildDailyExtraAttributeOptions(includeDisallowed = false) {
        ...
        const options = this._dailyExtraOptions.length ? this._dailyExtraOptions.filter((opt)=>includeDisallowed || !disallowed.has(opt)) : [];
        const solarOption = this._solarForecastEntryIds.length ? [
            {
                value: $112bd870a911c060$var$SOLAR_FORECAST_OPTION,
                label: (0, $b25jb.localize)('editor.common.solar_forecast', '', '')
    ...
    _buildSchemas() {
        ...
        if (!this._config?.compact_header) headerSchema.push({
    ...
    _getSupportedForecastTypes(stateObj) {
        ...
        if ((features & $112bd870a911c060$var$WeatherEntityFeature.FORECAST_TWICE_DAILY) !== 0) supported.push('twice_daily');
    ...
    constructor(...args){
        super(...args), this._hourlyExtraOptions = [], this._dailyExtraOptions = [], this._forecastOptionsLoading = {
            hourly: false,
            daily: false,
            twice_daily: false
        }, this._solarForecastOptions = [], this._solarForecastEntryIds = [], this._expandedSections = {}, this._forecastOptionSubscriptions = {}, this._solarForecastOptionsLoaded = false, this._computeLabel = (schema)=>{
...
], $112bd870a911c060$export$4f33cd896d7e371b.prototype, "hass", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.state)()
], $112bd870a911c060$export$4f33cd896d7e371b.prototype, "_config", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.state)()
], $112bd870a911c060$export$4f33cd896d7e371b.prototype, "_hourlyExtraOptions", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.state)()
], $112bd870a911c060$export$4f33cd896d7e371b.prototype, "_dailyExtraOptions", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.state)()
], $112bd870a911c060$export$4f33cd896d7e371b.prototype, "_forecastOptionsLoading", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.state)()
], $112bd870a911c060$export$4f33cd896d7e371b.prototype, "_solarForecastOptions", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.state)()
], $112bd870a911c060$export$4f33cd896d7e371b.prototype, "_solarForecastEntryIds", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.state)()
], $112bd870a911c060$export$4f33cd896d7e371b.prototype, "_expandedSections", void 0);
...
class $45e8d840e7b2fd10$export$36fcb699c9edd272 extends (0, $j0ZcV.LitElement) {
    ...
    constructor(...args){
        super(...args), this._type = 'attribute', this._computeLabel = (schema)=>{
            if (!this.hass) return schema.name;
            return this.hass.localize(`ui.panel.lovelace.editor.card.generic.${schema.name}`) || (0, $b25jb.localize)(`editor.card.${schema.name}`) || schema.name;
        };
    }
}
(0, $39J5i.__decorate)([
...
], $45e8d840e7b2fd10$export$36fcb699c9edd272.prototype, "hass", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.property)({
        attribute: false
    })
], $45e8d840e7b2fd10$export$36fcb699c9edd272.prototype, "weatherEntity", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.property)({
        attribute: false
    })
], $45e8d840e7b2fd10$export$36fcb699c9edd272.prototype, "config", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.state)()
], $45e8d840e7b2fd10$export$36fcb699c9edd272.prototype, "_type", void 0);
...
], $a457f49adfc911a0$export$ae477bd7d152d363.prototype, "hass", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.property)({
        attribute: false
    })
], $a457f49adfc911a0$export$ae477bd7d152d363.prototype, "config", void 0);
(0, $39J5i.__decorate)([
    (0, $1ZxoT.property)({
        attribute: false
    })
], $a457f49adfc911a0$export$ae477bd7d152d363.prototype, "extraAttributeOptions", void 0);
...
//# sourceMappingURL=detailed-weather-forecast-editor.48fb3b04.js.map
