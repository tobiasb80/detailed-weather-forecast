...
export type ExtendedHomeAssistant = HomeAssistant & {
  ...
  formatEntityAttributeValue?: (stateObj: HassEntity, attribute: string, value?: number | string) => string | undefined;
...
const getWeatherStateSVG = (state: string, nightTime?: boolean): SVGTemplateResult => svg`
  <svg
...
const supportsFeature = (stateObj: HassEntity, feature: number): boolean =>
