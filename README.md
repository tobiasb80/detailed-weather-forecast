...
| `rain_sensor_entity`           | string           | none                                    | Optional sensor entity (`precipitation_intensity`) used to control the presence and intensity of the rain animation on the background.                                                 |
